...
public:
		...
		bool resetAllRenderstates, IMaterialRendererServices* services)
	{
		...
		// printf("disableTextures"); Driver->testGLError();

		Driver->setActiveTexture(0, material.getTexture(0));
		// printf("setActiveTexture"); Driver->testGLError();

		Driver->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
		// printf("setBasicRenderStates"); Driver->testGLError();
		...
		if (resetAllRenderstates || (material.MaterialType != lastMaterial.MaterialType))
		{
			...
			// printf("GL_TEXTURE_ENV"); Driver->testGLError();
		}
	}
};
...
//			resetAllRenderstates)
		{
        	...
        	// printf("GL_GREATER"); Driver->testGLError();
                ...
                textureBlendFunc_hasAlpha(srcAlphaFact) || textureBlendFunc_hasAlpha(dstAlphaFact))
			{
        		...
        		// printf("textureBlendFunc_hasAlpha"); Driver->testGLError();
			}
		}
	}
