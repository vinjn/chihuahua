...
public:
	...
	COGLES2MaterialRenderer(
        ...
        const core::array<u8>& vertexShaderProgram = core::array<u8>(0),
...
protected:
	...
	void init(s32& outMaterialTypeNr, const core::array<u8>& vertexShaderProgram, const core::array<u8>& pixelShaderProgram, bool addMaterial = true);
