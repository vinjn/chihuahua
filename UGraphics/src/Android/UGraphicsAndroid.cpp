...
extern "C"
{
    ...
    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Scene_1initializeFileSystem(JNIEnv * env, jclass cls, jstring jInternalDataPath, jobject assetManager)
    {
    ...
    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1addLightNode(JNIEnv * env, jclass cls)
    {
    ...
    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Scene_1clear(JNIEnv * env, jclass cls)
    {
        Scene_clear();
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Scene_1render(JNIEnv * env, jclass cls)
    {
        Scene_render();
    }

    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1getNodeFromName(JNIEnv * env, jclass cls, jstring jNodeName)
    {
    ...
    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1loadScene(JNIEnv * env, jclass cls, jstring jSceneFileName)
    {
    ...
    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1addCubeNode(JNIEnv * env, jclass cls, jfloat size)
    {
        return Scene_addCubeNode(size);
    }

    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1addPlaneNode(JNIEnv * env, jclass cls, jfloat width, jfloat height)
    {
        return Scene_addPlaneNode(width, height);
    }

    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1addSphereNode(JNIEnv * env, jclass cls, jfloat radius)
    {
        return Scene_addSphereNode(radius);
    }

    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1addTexture(JNIEnv * env, jclass cls, jstring jTextureName)
    {
    ...
    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setTexture(JNIEnv * env, jclass cls, jlong nodePtr, jlong texturePtr)
    {
        Node_setTexture(nodePtr, texturePtr);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setTextureAtLayer(JNIEnv * env, jclass cls, jlong nodePtr, jint textureLayer, jlong texturePtr)
    {
        Node_setTextureAtLayer(nodePtr, textureLayer, texturePtr);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_MeshNode_1setAnimationFps(JNIEnv * env, jclass cls, jlong nodePtr, jfloat fps)
    {
        MeshNode_setAnimationFps(nodePtr, fps);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_MeshNode_1setAnimationLoop(JNIEnv * env, jclass cls, jlong nodePtr, jboolean isLoop)
    {
        MeshNode_setAnimationLoop(nodePtr, isLoop);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_MeshNode_1setAnimationByRange(JNIEnv * env, jclass cls, jlong nodePtr, jint start, jint end)
    {
        MeshNode_setAnimationByRange(nodePtr, start, end);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_MeshNode_1setAnimationByName(JNIEnv * env, jclass cls, jlong nodePtr, jstring jAnimationName)
    {
    ...
    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_MeshNode_1setAnimationByIndex(JNIEnv * env, jclass cls, jlong nodePtr, jlong index)
    {
    ...
    */
    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Scene_1setAnimationCallback(JNIEnv * env, jclass cls, jobject jCallbackInterface)
    {
    ...
    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Scene_1destroy(JNIEnv * env, jclass cls)
    {
        Scene_destroy();
    }

    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1getRootNode(JNIEnv *env, jclass cls)
    {
        return Scene_getRootNode();
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setLighting(JNIEnv *env, jclass cls, jlong nodePtr, jboolean enabled)
    {
        Node_setLighting(nodePtr, enabled);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setVisible(JNIEnv *env, jclass cls, jlong nodePtr, jboolean visible)
    {
        Node_setVisible(nodePtr, visible);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setBillboard(JNIEnv *env, jclass cls, jlong nodePtr, jboolean isBillboard)
    {
        Node_setBillboard(nodePtr, isBillboard);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setPosition(JNIEnv * env, jclass cls, jlong nodePtr, jfloat x, jfloat y, jfloat z)
    {
        Node_setPosition(nodePtr, x, y, z);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setRotation(JNIEnv * env, jclass cls, jlong nodePtr, jfloat x, jfloat y, jfloat z)
    {
        Node_setRotation(nodePtr, x, y, z);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setScale(JNIEnv * env, jclass cls, jlong nodePtr, jfloat x, jfloat y, jfloat z)
    {
        Node_setScale(nodePtr, x, y, z);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setParent(JNIEnv * env, jclass cls, jlong nodePtr, jlong parentPtr)
    {
        Node_setParent(nodePtr, parentPtr);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setMaterialType(JNIEnv * env, jclass cls, jlong nodePtr, MaterialType materialType)
    {
        Node_setMaterialType(nodePtr, materialType);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Node_1setModelMatrix(JNIEnv * env, jclass cls, jlong nodePtr, jfloatArray jMatrix)
    {
    ...
    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Camera_1setViewMatrix(JNIEnv * env, jclass cls, jfloatArray jMatrix)
    {
        jfloat *matrix = env->GetFloatArrayElements(jMatrix, JNI_FALSE);
    ...
    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Camera_1setProjectionMatrix(JNIEnv * env, jclass cls, jfloatArray jMatrix)
    {
        jfloat *matrix = env->GetFloatArrayElements(jMatrix, JNI_FALSE);
    ...
    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1addEmptyTexture(JNIEnv * env, jclass cls, jint width, jint height)
    {
        return Scene_addEmptyTexture(width, height);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Texture_1update(JNIEnv * env, jclass cls, jlong texturePtr, jbyteArray jImageData)
    {
    ...
    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1addFullScreenTextureNode(JNIEnv *env, jclass cls, jlong texturePtr, jint rotationType)
    {
        return Scene_addFullScreenTextureNode(texturePtr, rotationType);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Texture_1renderFullScreen(JNIEnv *env, jclass cls, jlong texturePtr, jint rotationType)
    {
        Texture_renderFullScreen(texturePtr, rotationType);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_Texture_1write(JNIEnv *env, jclass cls, jlong texturePtr, jstring jFilename)
    {
    ...
    JNIEXPORT jlong JNICALL Java_com_uengine_gfx_UGraphics_Scene_1pickNodeFromScreen(JNIEnv *env, jclass cls, jint x, jint y)
    {
        return Scene_pickNodeFromScreen(x, y);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_LightNode_1setType(JNIEnv *env, jclass cls, jlong nodePtr, LightType lightType)
    {
        LightNode_setType(nodePtr, lightType);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_LightNode_1setRadius(JNIEnv *env, jclass cls, jlong nodePtr, float radius)
    {
        LightNode_setRadius(nodePtr, radius);
    }

    JNIEXPORT void JNICALL Java_com_uengine_gfx_UGraphics_LightNode_1setDiffuseColor(JNIEnv *env, jclass cls, jlong nodePtr, float r, float g, float b, float a)
    {
