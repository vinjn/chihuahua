...
namespace scene
{
	...
	You might want to use ue::scene::SAnimatedMesh, ue::scene::SMesh,
	ue::scene::SMeshBuffer etc. */
	...
	public:
		...
		/** \param idx The index to get the frames for.
		...
		//! Get frame loop data for a special animation type, identified by name.
		/** \param name Name of the animation.
		\param outBegin The returned beginning frame for animation type specified.
		\param outEnd The returned ending frame for the animation type specified.
		\param outFPS The number of frames per second, this animation should be played at.
		\return beginframe, endframe and frames per second for a special animation type. */
