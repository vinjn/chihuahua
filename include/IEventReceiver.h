...
//! SEvents hold information about an event. See ue::IEventReceiver for details on event handling.
struct SEvent
{
	 ...
	 * @ref ue::IrrlichtDevice::activateJoysticks() has been called, an event of
...
ue::EEVENT_TYPE for a description of where each type of event starts, and the
...
//! Information on a joystick, returned from @ref ue::IrrlichtDevice::activateJoysticks()
struct SJoystickInfo
{
	//! The ID of the joystick
	/** This is an internal Irrlicht index; it does not map directly
	 * to any particular hardware joystick. It corresponds to the
	 * ue::SJoystickEvent Joystick ID. */
	u8 Joystick;
